<script lang='ts'>
  ...
  import FormPost from '$lib/postagens/FormPost.svelte'
...
<div class="bg-slate-600 py-6 text-white">
  <div class="container mx-auto flex items-center justify-around">
    <div class="w-1/3 space-y-3">
      ...
      <button on:click={handleClick} class="capitalize font-semibold bg-white text-slate-800 px-4 py-2 rounded-lg border-2 border-slate-900 mx-auto block">nova postagem</button>
    </div>
